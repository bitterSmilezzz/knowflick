...
- **千卡千面智能背景与零相邻重复（Zero Adjacent Duplicate）**：内置 21 套精选科学与人文摄影底图，采用领域关联多图池（Tech / Finance / Science / Humanities），结合细化语义与确定性交织打散算法，保证连续刷卡时相邻两张卡片背景绝不撞图（0 连续重复），即使在单一分类内刷卡也张张不同、各美其美；主窗体环境光晕随顶卡与划卡飞出动画实时流转
